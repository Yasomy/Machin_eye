...
stream_url = "http://46.191.199.9/1660720512DSH176/tracks-v1/index.fmp4.m3u8?token=a80c27585fd346cbb56b84cb22af9797"
...
while cap.isOpened():
    ...
    # Изменяем размер кадра до 640x640 для YOLO
